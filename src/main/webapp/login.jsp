...
<body>
<div id="logo"><img src="${pageContext.request.contextPath }/images/logo.jpg" alt="大唐电信首页" width="1002" height="392"/>
</div>
<div class="login" id="middle">
    <spf:form action="emplogin" method="post"
              modelAttribute="form" name="form001" id="form001">
        <p>
            <label>
