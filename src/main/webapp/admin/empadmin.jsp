    ...
    <tr>
        <td class="rightimg"><!-- #BeginLibraryItem "/Library/left3.lbi" -->
            ...
            <div id="right">
                ...
                <form id="form1" name="form1" method="post" action="remove.do">
                    <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
                        ...
                        <c:forEach items="${empadmin.data}" var="e">
                            <tr>
                                ...
                                <td class="tdcolor"><fmt:formatDate value="${e.enrolldate }"
                ...
                <center>
                    ...
                    <a
                            href="${pageContext.request.contextPath }/input_remove.do?pageNo1=${empadmin.firstPage}&pageSize1=${empadmin.pageSize}">首页</a>
                    <a
                            href="${pageContext.request.contextPath }/input_remove.do?pageNo1=${empadmin.previousPage}&pageSize1=${empadmin.pageSize}">上一页</a>
                    <a
                            href="${pageContext.request.contextPath }/input_remove.do?pageNo1=${empadmin.nextPage}&pageSize1=${empadmin.pageSize}">下一页</a>
                    <a
                            href="${pageContext.request.contextPath }/input_remove.do?pageNo1=${empadmin.lastPage}&pageSize1=${empadmin.pageSize}">末页</a>
...
<div id="bottom"><img src="${pageContext.request.contextPath }/images/button.jpg" width="1002" height="17"/></div>
<!-- #EndLibraryItem --></body>
</html>
