		...
		<tr>
			<td class="rightimg">
				...
				<div id="right">
					...
					<form id="form1" name="form1" method="post" action="input_add.do">
						<table width="700" border="0" cellpadding="0" cellspacing="0"
							...
							<c:forEach items="${emps.data}" var="e">
								<tr>
					...
					<a>共${emps.lastPage }页</a>
						<a
							href="${pageContext.request.contextPath }/queryall.do?pageNo1=${emps.firstPage}&pageSize1=${emps.pageSize}">首页</a>
						<a
							href="${pageContext.request.contextPath }/queryall.do?pageNo1=${emps.previousPage}&pageSize1=${emps.pageSize}">上一页</a>
						<a
							href="${pageContext.request.contextPath }/queryall.do?pageNo1=${emps.nextPage}&pageSize1=${emps.pageSize}">下一页</a>
						<a 
						    href="${pageContext.request.contextPath }/queryall.do?pageNo1=${emps.lastPage}&pageSize1=${emps.pageSize}">末页</a>
						<a>第${emps.pageNo }页</a>
