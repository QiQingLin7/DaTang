  ...
  <tr>
    <td class="rightimg"><!-- #BeginLibraryItem "/Library/left.lbi" --><div id="left">
      ...
      <p><a href="exit.do" target="_self">退出系统</a></p>
        ...
        <h1>未实施任务信息:</h1>
        <form id="form1" name="form1" method="post" action="deltask.do">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <c:forEach items="${pbtkl.data }" var="t">
            <tr>
              <td><a href="adjust.do?taskId=${t.taskId }">${t.taskName }</a></td>
              <td>${t.assigner.employeeName }</td>
              <td>${t.beginDate }</td>
              <td>${t.endDate }</td>
              <td>${t.status }</td>
              <td><label>
                <input type="checkbox" name="deltaskId" value="${t.taskId }" />
              </label></td>
            </tr>
            </c:forEach>
          </table>
          <center>
       		  共${pbtkl.totalRecords }条记录&nbsp;
   			  共${pbtkl.lastPage }页&nbsp;
        		<a href="taskundoneshow.do?pageNo=${pbtkl.firstPage}&pageSize=${pbtkl.pageSize}">首页</a>
				<a href="taskundoneshow.do?pageNo=${pbtkl.previousPage}&pageSize=${pbtkl.pageSize}">上一页</a>
				<a href="taskundoneshow.do?pageNo=${pbtkl.nextPage}&pageSize=${pbtkl.pageSize}">下一页</a>
				<a href="taskundoneshow.do?pageNo=${pbtkl.lastPage}&pageSize=${pbtkl.pageSize}">末页</a>
  			  第${pbtkl.pageNo }页
  			  </center>
    <p>
            <label>
