    ...
    <td class="rightimg"><!-- #BeginLibraryItem "/Library/left.lbi" --><div id="left">
     <p><a href="taskview.do?pageNo=1&pageSize=4" target="_self">查看任务</a></p>
      ...
      <p><a href="exit.do" target="_self">退出系统</a></p>
        ...
        <spf:form id="form1" modelAttribute="taskMod" name="form1" method="post" action="taskModify.do">
          <p>任务名称：<label>
          <spf:hidden path="taskId" name="taskId" />
          <spf:input name="textfield" path="taskName" type="text" size="50" />
          </label></p>
          <p>任务描述：
            <label>
            <spf:textarea name="textfield2" path="taskDesc"></spf:textarea>
            </label>
          </p>
            <p>开始时间：
              <label>
                <spf:input name="textfield3" type="text" path="beginDate" size="16" />
              </label>
             <span class="marginleft1">结束时间：
              <label>
                <spf:input name="textfield4" path="endDate" type="text" size="16" />
              </label></span>
          </p>
          <p>实施人员：
            <label>
              <spf:select name="select" path="assigner.employeeId">
                <spf:options items="${tkCh }" itemLabel="employeeName" itemValue="employeeId"/>
              </spf:select>
            </label>
